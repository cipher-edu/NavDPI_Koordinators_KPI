...
class Kordinators(AbstractUser):
    ...
    #     verbose_name='Groups',
    #     blank=True,
    #     related_name='kordinators'  # Use a different related_name
    # )

    # # Add a related_name to resolve the clash with 'auth.User.user_permissions'
    # user_permissions = models.ManyToManyField(
    #     Permission,
    #     verbose_name='User Permissions',
    #     blank=True,
    #     related_name='kordinators_user_permissions'  # Use a different related_name
    # )
    def __str__(self):
        return self.name
